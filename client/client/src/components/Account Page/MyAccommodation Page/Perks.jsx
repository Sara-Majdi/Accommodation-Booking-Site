...
const Perks = ({selected, onChange}) => {
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-2">
        ...
        <label className="flex items-center p-4 border rounded-2xl gap-2 ">
            <input type="checkbox" name='sauna' onChange={handlePerksCheckbox} />
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-6 h-6">
        ...
        <label className="flex items-center p-4 border rounded-2xl gap-2 ">
            <input type="checkbox" name='air-conditioning' onChange={handlePerksCheckbox} />
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-6 h-6">
        ...
        <label className="flex items-center p-4 border rounded-2xl gap-2 ">
            <input type="checkbox" name='breakfast' onChange={handlePerksCheckbox} />
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-6 h-6">
        ...
        <label className="flex items-center p-4 border rounded-2xl gap-2 ">
            <input type="checkbox" name='swimming-pool' onChange={handlePerksCheckbox} />
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-6 h-6">
        ...
        <label className="flex items-center p-4 border rounded-2xl gap-2 ">
            <input type="checkbox" name='gym' onChange={handlePerksCheckbox} />
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-6 h-6">
        ...
        <label className="flex items-center p-4 border rounded-2xl gap-2 ">
            <input type="checkbox" name='balcony' onChange={handlePerksCheckbox} />
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-6 h-6">
        ...
        <label className="flex items-center p-4 border rounded-2xl gap-2 ">
            <input type="checkbox" name='security' onChange={handlePerksCheckbox} />
        ...
        <label className="flex items-center p-4 border rounded-2xl gap-2 ">
            <input type="checkbox" name='elevator' onChange={handlePerksCheckbox} />
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-6 h-6">
        ...
        <label className="flex items-center p-4 border rounded-2xl gap-2 ">
            <input type="checkbox" name='wheelchair-accessible' onChange={handlePerksCheckbox} />
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-6 h-6">
        ...
        <label className="flex items-center p-4 border rounded-2xl gap-2 ">
            <input type="checkbox" name='non-smoking-rooms' onChange={handlePerksCheckbox} />
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-6 h-6">
        ...
        <label className="flex items-center p-4 border rounded-2xl gap-2 ">
            <input type="checkbox" name='spa' onChange={handlePerksCheckbox} />
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-6 h-6">
        ...
        <label className="flex items-center p-4 border rounded-2xl gap-2 ">
            <input type="checkbox" name='room-service' onChange={handlePerksCheckbox} />
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-6 h-6">
        ...
        <label className="flex items-center p-4 border rounded-2xl gap-2 ">
            <input type="checkbox" name='bar' onChange={handlePerksCheckbox} />
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-6 h-6">
        ...
        <label className="flex items-center p-4 border rounded-2xl gap-2 ">
            <input type="checkbox" name='ocean-view' onChange={handlePerksCheckbox} />
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-6 h-6">
        ...
        <label className="flex items-center p-4 border rounded-2xl gap-2 ">
            <input type="checkbox" name='shower' onChange={handlePerksCheckbox} />
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-6 h-6">
        ...
        <label className="flex items-center p-4 border rounded-2xl gap-2 ">
            <input type="checkbox" name='restaurants' onChange={handlePerksCheckbox} />
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-6 h-6">
        ...
        <label className="flex items-center p-4 border rounded-2xl gap-2 ">
            <input type="checkbox" name='pet-friendly' onChange={handlePerksCheckbox} />
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-6 h-6">
        ...
        <label className="flex items-center p-4 border rounded-2xl gap-2 ">
            <input type="checkbox" name='laundry' onChange={handlePerksCheckbox} />
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-6 h-6">
        ...
        <label className="flex items-center p-4 border rounded-2xl gap-2 ">
            <input type="checkbox" name='city-view' onChange={handlePerksCheckbox} />
        ...
        <label className="flex items-center p-4 border rounded-2xl gap-2 ">
            <input type="checkbox" name='garden' onChange={handlePerksCheckbox} />
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-6 h-6">
        ...
        <label className="flex items-center p-4 border rounded-2xl gap-2 ">
            <input type="checkbox" name='concierge' onChange={handlePerksCheckbox} />
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-6 h-6">
