...
const Perks = ({selected, onChange}) => {
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-2">
        ...
        <label className="flex items-center p-4 border rounded-2xl gap-2 ">
            <input type="checkbox" checked={selected.includes('Free Parking')} name='Free Parking' onChange={handlePerksCheckbox} />
        ...
        <label className="flex items-center p-4 border rounded-2xl gap-2 ">
            <input type="checkbox" checked={selected.includes('Breakfast Included')} name='Breakfast Included' onChange={handlePerksCheckbox} />
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-6 h-6">
        ...
        <label className="flex items-center p-4 border rounded-2xl gap-2 ">
            <input type="checkbox" checked={selected.includes('24-Hour Security')} name='24-Hour Security' onChange={handlePerksCheckbox} />
        ...
        <label className="flex items-center p-4 border rounded-2xl gap-2 ">
            <input type="checkbox" checked={selected.includes('Flat-screen TV')} name='Flat-screen TV' onChange={handlePerksCheckbox} />
